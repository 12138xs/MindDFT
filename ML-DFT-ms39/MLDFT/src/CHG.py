...
class model_atomO_chg(nn.Cell):
    ...
    def construct(self,input4):
        ...
        return model_out_expO

class modelCHG(nn.Cell):
    def __init__(self,padding_size):
        super(modelCHG, self).__init__()
        self.time_distributed_1 = nn.TimeDistributed(model_atomC_chg(),time_axis=1, reshape_with_axis=0)
        self.time_distributed_2 = nn.TimeDistributed(model_atomH_chg(),time_axis=1, reshape_with_axis=0)
        self.time_distributed_3 = nn.TimeDistributed(model_atomN_chg(),time_axis=1, reshape_with_axis=0)
        self.time_distributed_4 = nn.TimeDistributed(model_atomO_chg(),time_axis=1, reshape_with_axis=0)
