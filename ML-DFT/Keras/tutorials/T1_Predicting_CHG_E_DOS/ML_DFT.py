...
def ML_DFT(file_loc):
    print('Predicting atomic charges, energy and DOS for the system in:', file_loc)
    ...
    if test_e or test_dos:
        ...
        print("#-----------------Energy and DOS prediction-----------------#")
        print(X_3D1.shape,X_3D2.shape,X_3D3.shape,X_3D4.shape)
        print(X_C.shape,X_H.shape,X_N.shape,X_O.shape)
    if test_e:
...
print('====================Total Time taken for training:', train_time-start_time)
print('====================Total Time taken for inference:', infer_time-train_time)
print('====================Total Time taken for ML_DFT:', infer_time-start_time)
